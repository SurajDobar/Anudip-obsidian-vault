...
3.  **Prepension:** Insert the TOC at the very top of the file.
4.  **Clean Separation:** Leave exactly one blank line between the TOC and the start of the original content.
5.  **Content Integrity:** Under no circumstances should the original content below the TOC be edited, summarized, or reformatted, except for the heading standardization described in step 1.
